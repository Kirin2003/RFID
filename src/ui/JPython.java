...
public class JPython {
    public static void Graphic(double time1, double time2, double time3, String str) throws IOException {
        ...
        String[] argg = new String[] { "python3", "/home/hxq/Desktop/2022spring_semester/RFID/pictures/test2.py", String.valueOf(time1), String.valueOf(time2), String.valueOf(time3), str};
